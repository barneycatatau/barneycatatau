...
> There is no such thing as overengineering, only future requirements that haven't arrived yet.

> A good IPA is remarkably similar to a good piece of software: initially bitter, occasionally misunderstood, and ultimately appreciated by a surprisingly dedicated community.
...
- Simplicity is often achieved only after several iterations of unnecessary complexity.
- Every engineer eventually becomes a systems administrator.
- Every systems administrator eventually writes code.
